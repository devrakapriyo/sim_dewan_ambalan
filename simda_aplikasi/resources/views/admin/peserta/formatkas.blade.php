...
<table border="1" cellspacing="5" cellpadding="5" width="100%" style="border-collapse:collapse;">
	<thead>
		<tr>
			...
			<td rowspan="3">JK</td>
			<td colspan="55" style="text-align:center; background-color:#8bc34a; color:#fff;">Daftar Absensi Sangga {{$ket->sangga}} Ambalan {{$ket->ambalan}}</td>
		</tr>
		<tr>
